...
class BaseDataset(Dataset):
    ...
    def __init__(self, config=None, is_validation=False):
        ...
        self.load_data()
        #print("before ", len(self.data_loaded.keys()))
        
        #new_data_loaded = {}
        #new_data_loaded_keys = []
        #for count, k in enumerate(self.data_loaded_keys):
        #    if count >= 8:
        #        break
        #    new_data_loaded[k] = self.data_loaded[k]

        #self.data_loaded = new_data_loaded
        #self.data_loaded_keys = list(self.data_loaded.keys())
        #print('after ', len(self.data_loaded.keys()))
    def load_data(self):
        self.data_loaded = {}
